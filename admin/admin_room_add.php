                ...
                <div class="card add-room-form-card">
                    ...
                    <form id="add-room-form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" rows="5" placeholder="tuliskan detail dari room. termasuk fitur fitur yang ada"></textarea>
                        </div>
                        
                        <div class="form-row">
                            <div class="form-group">
                                <label for="price_per_night">Price per Night</label>
                                <input type="text" id="price_per_night" name="price_per_night" placeholder="000" required>
                            </div>
                            <div class="form-group">
